...
class Creditos:
    ...
    def __init__(self):
        ...
        try:
            self.font = pygame.font.Font(r"C:\Users\eduar\Desktop\U Cundinamarca\DIrectorio PRORAMACION - UDEC\Programacion  I -204 - Segundo Semestre\game\juegodeNave\assets\game_of_squids\Game Of Squids.ttf", 25)
        except pygame.error:
